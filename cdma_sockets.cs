...
namespace cdma_sockets
{
    ...
    {     
        ...
        public void beginReceiving()
        {
                ...
                {                    
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            Console.WriteLine("Recceived length: {0}", messageLength);
            ...
            thread.Name = "Client Receive Thread";
            thread.Start();
        ...
        private void startConnections()
        {
            ...
            Thread th = new Thread(delegate()
            {
                while (true)
                {
                    ...
                    clients.Add(client, "");
                    Console.WriteLine("Client added. (Total: {0})", clients.Count);
            ...
            Thread th = new Thread(delegate()
            {
                while (true)
                {
                    try
                    {
                        ...
                        if (messageLength < 0)
                            continue;
                        Console.WriteLine("Receiving message length: {0}", messageLength);
